...
api_key = "AIzaSyD93Eee1wzs-prrgtCue6AIu00ZNHBnJcY"
...
def Adoption1(request):
    return render(request, "Adoption1.html")
def Adoption2(request):
    return render(request, "Adoption2.html")

def shop(request):
    if request.method == 'POST':
        client = razorpay.Client(auth=("rzp_test_pm7FRker83IOGD", "EoEQZTjEw9GKmdWsqFpUZFqm"))
